...
cities = {
    'москва': ['997614/67a332155286f1b0e6fe',
               '1030494/b9e3e444f6ea3f5d740d'],
    'нью-йорк': ['997614/b68152db9a38dab2e7b7',
                 '213044/3318bb1d08636d743cfe'],
    'париж': ["965417/016e5cb12f55eb12789d",
              '965417/a262a097fc879d5b27ee']
}
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if not sessionStorage[user_id]['game_started']:
            ...
            if 'да' in req['request']['nlu']['tokens']:
                ...
                res['response']['text'] = 'GG Помогающий текст'
            else:
